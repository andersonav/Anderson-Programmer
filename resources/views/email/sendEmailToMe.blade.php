                                            ...
                                            <div style="color:#7c4b96;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;line-height:1.2;padding-top:10px;padding-right:10px;padding-bottom:0px;padding-left:10px;">
                                                <div style="line-height: 1.2; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 12px; color: #7c4b96; mso-line-height-alt: 14px;">
                                                    <p style="line-height: 1.2; font-size: 22px; mso-line-height-alt: 26px; margin: 0;">
                                                        <span style="font-size: 22px;"><strong>Cliente {{$nome}}</strong></span></p>
                                                </div>
                                            </div>
                                            ...
                                            <div style="color:#777777;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;line-height:1.2;padding-top:5px;padding-right:10px;padding-bottom:5px;padding-left:10px;">
                                                <div style="font-size: 12px; line-height: 1.2; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; color: #777777; mso-line-height-alt: 14px;">
                                                    <p style="font-size: 16px; line-height: 1.2; mso-line-height-alt: 19px; margin: 0;">
                                                        <span style="font-size: 16px;">{{$mensagem}}</span></p>
                                                </div>
                                            </div>
                                            <!--[if mso]></td></tr></table><![endif]-->
                                            ...
                                            <div style="color:#bbbbbb;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;line-height:1.2;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
                                                <div style="font-size: 12px; line-height: 1.2; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; color: #bbbbbb; mso-line-height-alt: 14px;">
                                                    <p style="font-size: 18px; line-height: 1.2; text-align: center; mso-line-height-alt: 22px; margin: 0;">
                                                        Telefone cliente: {{$telefone}} - Email: {{$email}}
                                                    </p>
                                                </div>
                                            </div>
                                            <!--[if mso]></td></tr></table><![endif]-->
